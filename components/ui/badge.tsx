...
const badgeVariants = cva(
  "inline-flex items-center  justify-center rounded-5xl transition-all ease-in-out text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-0.75 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        md: "px-1.5 py-0.75 text-xs font-normal [&>svg]:size-3 tracking-4 leading-tight",
        lg: "px-2 py-1 text-sm font-normal [&>svg]:size-3 tracking-4 leading-tight",
      },
    },
    defaultVariants: {
      variant: "default",
