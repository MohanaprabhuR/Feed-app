...
const textareaVariants = cva(
  "flex w-full rounded-lg  placeholder:text-primary/50   font-normal disabled:cursor-not-allowed disabled:pointer-events-none disabled:bg-primary/3 disabled:text-primary/20 disabled:border-transparent",
  {
    variants: {
      ...
      size: {
        sm: "min-h-18 h-full px-2 py-1.5 text-base leading-normal tracking-4",
        md: "min-h-25.5 px-3 py-2.5 text-lg rounded-xl leading-tight tracking-4",
        lg: "min-h-31.5 px-3.5 py-3 text-xl rounded-xl leading-tight tracking-4",
      },
      status: {
        default: "",
        success: "",
